      ...
      <div className="max-w-screen-xl mx-auto px-6 py-10 bg-red-100 flex flex-col justify-start items-start gap-6 overflow-hidden">
        <div className="w-full flex flex-col justify-start items-center gap-10">
          <div className="w-full text-center">
            <span className="text-Primary-Red text-4xl md:text-6xl font-bold tracking-wide">
              Contact
            </span>
            <span className="text-Dark-Primary text-4xl md:text-6xl font-bold tracking-wide">
              {" "}Us
            </span>
          </div>
          <div className="w-full flex justify-center items-center gap-10 flex-wrap">
            <div className="w-40 h-40 md:w-48 md:h-48 relative bg-red-200 rounded-lg overflow-hidden">
              <div className="w-20 md:w-24 left-1/4 top-1/4 absolute flex flex-col justify-start items-center gap-2">
                <div className="w-10 md:w-12 h-10 md:h-12 relative bg-white rounded-full outline-1 outline-Primary-Red flex justify-center items-center text-2xl md:text-3xl">
                  📞
                </div>
